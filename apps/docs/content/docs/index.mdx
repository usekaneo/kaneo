...
Now that you have Kaneo running, explore these deployment options for production:
...
- **[Core Concepts](/docs/concepts/overview)** - Learn about Kaneo's architecture and features
