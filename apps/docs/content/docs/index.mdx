...
| `SMTP_HOST`            | Email server hostname for notifications      | No       | -       |
| `SMTP_PORT`            | Email server port (587 for TLS, 465 for SSL) | No       | `587`   |
| `SMTP_USER`            | Email server username                        | No       | -       |
| `SMTP_PASS`            | Email server password or app password        | No       | -       |
| `FROM_EMAIL`           | Sender email address for notifications       | No       | -       |
| `FROM_NAME`            | Sender name for email notifications          | No       | `Kaneo` |
