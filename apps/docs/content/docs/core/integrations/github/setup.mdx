...
1. **[Deploy Kaneo](/docs/core)** - Deploy your Kaneo instance with the GitHub App credentials
2. **[Configure GitHub Integration](/docs/core/integrations/github/configuration)** - Complete the integration setup in your deployed Kaneo instance
3. **[Connect Repositories](/docs/core/integrations/github/configuration#connecting-repositories)** - Link your projects to GitHub repositories
