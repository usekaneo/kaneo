---
title: Railway
description: Deploy Kaneo to Railway using the official template.
---
import { DeployButton } from "@/components/ai/page-actions";

## Railway Template

Kaneo provides an official Railway template for easy deployment with a single click.

<DeployButton href="https://railway.com/deploy/kaneo">
  Deploy on Railway
</DeployButton>
...
For more detailed troubleshooting, see the [troubleshooting section](/docs/core/installation/start-services).