...
This guide walks you through creating and configuring a GitHub App to enable the Kaneo integration.
...
- Receive webhook events (optional)
...
- **Homepage URL**: Your Kaneo instance URL (e.g., `https://kaneo.yourdomain.com`)
...
Replace `your-kaneo-instance.com` with your actual Kaneo domain. The webhook URL must be publicly accessible.
</Callout>
</Step>
...
If you want to receive webhook events from GitHub, subscribe to:

- **Issues** - To track when issues are created, updated, or closed
- **Issue Comments** - To track comments on issues

<Callout type="info">
Webhook events are optional and currently used for logging. Future versions may use these for bidirectional sync.
</Callout>
</Step>
...
Once your GitHub App is created and installed:

1. **[Configure Kaneo](/docs/integrations/github/configuration)** - Add the credentials to your Kaneo deployment
2. **[Connect Repositories](/docs/integrations/github/configuration#connecting-repositories)** - Link your projects to GitHub repositories
