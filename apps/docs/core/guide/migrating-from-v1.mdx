...
For more information, see the [Environment variables](/core/installation/environment-variables) page.
...
For the complete compose file, see the [Docker Compose](/core/installation/docker-compose) page.