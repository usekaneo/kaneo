---
title: Gitea Setup
description: Connect Kaneo to a Gitea instance (issues, pull requests, webhooks).
---

## Overview

The Gitea integration links a Kaneo project to a repository on your Gitea instance. Tasks sync with issues, and webhooks keep Kaneo updated when issues, pull requests, or pushes change.
