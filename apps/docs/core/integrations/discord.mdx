---
title: Discord
description: Send task notifications from Kaneo to a Discord channel using incoming webhooks.
---

Kaneo can post task activity to a Discord channel whenever events occur in a project. This uses Discord's incoming webhook feature, so no bot or OAuth setup is required.
