    ...
    >
      ...
      {id ? (
        <button
          ...
          className={cn(
            "absolute end-2 top-1/2 -translate-y-1/2 h-6 w-6 rounded-md text-muted-foreground/40 transition-colors hover:text-muted-foreground/70 hover:bg-transparent",
          )}
        >
