...
import {
  ...
  assetTableRelations,
  calBookingTableRelations,
  clientPartnerTableRelations,
  clientTableRelations,
  columnTableRelations,
  commentTableRelations,
  contractSubmissionTableRelations,
  contractTemplateTableRelations,
...
import {
  ...
  instanceBrandingTable,
  instanceLicenseTable,
  integrationTable,
  invitationTable,
  labelTable,
  licenseKeyTable,
