...
- Private-network notification receivers (`KANEO_ALLOW_PRIVATE_WEBHOOK_DESTINATIONS=true` lets ntfy/Gotify/webhook destinations, self-managed Gitea/GitLab instances, and custom Telegram Bot API servers resolve to private addresses; off by default to prevent SSRF)
